              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center max-w-md p-6">
                  ...
                  <div className="mt-6 flex justify-center space-x-4">
                    <button onClick={addFile} className="px-4 py-2 bg-[#333333] hover:bg-[#444444] text-white rounded-md border border-[#555555] transition-all">
                      New File
                    </button>
                    <button onClick={addFolder} className="px-4 py-2 bg-[#333333] hover:bg-[#444444] text-white rounded-md border border-[#555555] transition-all">
                      New Folder
                    </button>
                  </div>
                </div>
